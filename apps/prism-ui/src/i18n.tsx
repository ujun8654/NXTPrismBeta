...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // ─── Report Viewer (보고서 내용 렌더링) ───
  'rpt.auditReport.title': { en: 'System Audit Report', ko: '종합 시스템 감사 보고서' },
  'rpt.chainAudit.title': { en: 'Chain Integrity Audit', ko: '체인 무결성 감사' },
  'rpt.compliance.title': { en: 'Compliance Snapshot', ko: '규정 준수 스냅샷' },
  'rpt.overrideHistory.title': { en: 'Override History Export', ko: '오버라이드 이력 내보내기' },
  'rpt.generatedAt': { en: 'Generated', ko: '생성 시간' },
  'rpt.auditedAt': { en: 'Audited', ko: '감사 시간' },
  'rpt.capturedAt': { en: 'Captured', ko: '캡처 시간' },
  'rpt.exportedAt': { en: 'Exported', ko: '내보내기 시간' },
  'rpt.summary': { en: 'Summary', ko: '요약' },
  'rpt.chainIntegrity': { en: 'Chain Integrity', ko: '체인 무결성' },
  'rpt.chainValid': { en: 'VALID — No tampering detected', ko: '정상 — 위변조 없음' },
  'rpt.chainInvalid': { en: 'INVALID — Tampering detected', ko: '이상 — 위변조 감지됨' },
  'rpt.recordsChecked': { en: 'Records checked', ko: '검증된 레코드' },
  'rpt.invalidAtSeq': { en: 'Invalid at sequence', ko: '위변조 감지 시퀀스' },
  'rpt.evidenceStats': { en: 'Evidence Statistics', ko: '증거 통계' },
  'rpt.totalRecords': { en: 'Total Records', ko: '전체 레코드' },
  'rpt.byDecision': { en: 'By Decision', ko: '결정 연관' },
  'rpt.byPolicy': { en: 'By Policy', ko: '정책 연관' },
  'rpt.byTransition': { en: 'By Transition', ko: '전이 연관' },
  'rpt.earliest': { en: 'Earliest', ko: '최초 기록' },
  'rpt.latest': { en: 'Latest', ko: '최근 기록' },
  'rpt.transitionSummary': { en: 'Transition Summary', ko: '전이 요약' },
  'rpt.totalTransitions': { en: 'Total Transitions', ko: '전체 전이' },
  'rpt.byResult': { en: 'By Result', ko: '결과별' },
  'rpt.byGateMode': { en: 'By Gate Mode', ko: '게이트 모드별' },
  'rpt.byStatus': { en: 'By Status', ko: '상태별' },
  'rpt.byReasonCode': { en: 'By Reason Code', ko: '사유별' },
  'rpt.overrideKpis': { en: 'Override KPIs', ko: '오버라이드 KPI' },
  'rpt.overrideSummary': { en: 'Override Summary', ko: '오버라이드 현황' },
  'rpt.overrideRecords': { en: 'Override Records', ko: '오버라이드 목록' },
  'rpt.policyTimeline': { en: 'Policy Timeline', ko: '정책 타임라인' },
  'rpt.policyName': { en: 'Policy Name', ko: '정책명' },
  'rpt.version': { en: 'Version', ko: '버전' },
  'rpt.publishedAt': { en: 'Published', ko: '배포일' },
  'rpt.activePolicies': { en: 'Active Policies', ko: '활성 정책' },
  'rpt.assetStates': { en: 'Asset States', ko: '자산 상태' },
  'rpt.asset': { en: 'Asset', ko: '자산' },
  'rpt.checkpoints': { en: 'Checkpoints', ko: '체크포인트' },
  'rpt.range': { en: 'Range', ko: '범위' },
  'rpt.records': { en: 'Records', ko: '레코드' },
  'rpt.merkleRoot': { en: 'Merkle Root', ko: '머클 루트' },
  'rpt.totalEvidence': { en: 'Total Evidence', ko: '전체 증거' },
  'rpt.totalPacks': { en: 'Evidence Packs', ko: '증거 팩' },
};
